        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            if(isset($_POST[submit_pass]))
            {
                ...
                if($_POST[old_pass]==$_SESSION[admin_password])
                {
                    if($_POST[n_pass]==$_POST[c_pass])
                    {
						//echo $con;
				$update_query="UPDATE `admin_password` SET `admin_password`='$_POST[n_pass]' WHERE `admin_password`.`admin_id` = '1';";
			
							if($con->query($update_query) === TRUE)
							{
								$_SESSION[admin_password]=$_POST[n_pass];
		/*	////////////////////for sending sms
